...
// Sign Out Equipment = a student borrowing equipment. Scans the student's
// barcode, looks them up, then scans the equipment barcode and POSTs to
// /api/equipment/signout (backend toggles the equipment out).
    ...
    <div className="scan-container">
      <div className="scan-panel glass-panel">
        <div className="scan-header">
          ...
          <h1 className="scan-title">Sign Out Equipment</h1>
        </div>
        ...
        {result && (
          <div className="scan-fields">
            <h2 className="scan-title">Equipment signed out</h2>
            <p className="scan-status">Barcode: {equipmentBarcode}</p>
            <p className="scan-status">Taken at: {result.time_out}</p>
            <button type="button" className="action-btn" onClick={resetEquipmentScan}>
              Sign out another item for {student.name_first}
            </button>
